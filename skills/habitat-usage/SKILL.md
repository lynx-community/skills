...
- Configure and sync dependencies in a “main repo + dependency repos” setup
- Support git source deps, nested solutions, HTTP downloads, and custom actions
- Quickly diagnose and fix common config/auth/network/integrity issues
