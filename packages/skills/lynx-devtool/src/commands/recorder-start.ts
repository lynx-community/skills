...
type ConnectorGlobalSwitch = (clientId: string, key: typeof DEBUG_MODE_KEY) => Promise<boolean>;
type ConnectorSetGlobalSwitch = (clientId: string, key: typeof DEBUG_MODE_KEY, value: boolean) => Promise<void>;
type ConnectorCDPMessage = (clientId: string, sessionId: number, method: string, params: object) => Promise<unknown>;
