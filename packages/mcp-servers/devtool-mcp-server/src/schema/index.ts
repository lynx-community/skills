...
export const backendNodeId = z.number().describe('Backend node identifier.');
...
export const selector = z.string().describe('CSS selector string');

export const query = z.string().describe('Search query string');

export const searchId = z
  .union([z.number(), z.string()])
  .describe(
    'Search identifier returned by `DOM.performSearch`. Pass it through unchanged.',
  );

export const fromIndex = z.number().describe('Start index for search results');

export const toIndex = z.number().describe('End index for search results');

export const x = z.number().describe('X coordinate');

export const y = z.number().describe('Y coordinate');
...
export const pierce = z
  .boolean()
  .optional()
  .describe('Whether to pierce through shadow DOM');

export const backendNodeIds = z
  .array(z.number())
  .describe('Array of backend node IDs');

export const includeUserAgentShadowDOM = z
  .boolean()
  .optional()
...
export const styleSheetId = z.string().describe('Style sheet identifier');
...
export const screenshotMode = z
  .enum(['lynxview', 'fullscreen'])
  .describe(
