...
The server is maintained in [lynx-community/skills](https://github.com/lynx-community/skills/tree/main/packages/mcp-servers/docs-mcp-server).

From the repository root:

```bash
pnpm install
pnpm --filter @lynx-js/docs-mcp-server build
node packages/mcp-servers/docs-mcp-server/dist/main.js --help
```

To run the built server with versioned documentation:

```bash
node packages/mcp-servers/docs-mcp-server/dist/main.js --base-url https://lynxjs.org/next/
```
